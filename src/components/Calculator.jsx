      ...
      >
        ...
        <div className="mt-6 flex flex-col items-center">
          <button
            ...
            className="w-full md:w-auto px-8 py-4 text-lg font-semibold text-white bg-[#0066FF] dark:bg-[#1D9BF0] hover:bg-[#0052CC] dark:hover:bg-[#1A8CD8] rounded-lg shadow-md hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#0066FF] dark:focus:ring-[#1D9BF0] focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center min-h-[56px]"
          >
            {isLoading ? (
              <>
          ...
          {/* Trust Signals */}
          <p className="mt-2 text-sm text-[#4B5563] dark:text-[#9CA3AF] transition-colors duration-300">
            {t('calculator.trustSignals')}
          </p>
        </div>
      </form>
